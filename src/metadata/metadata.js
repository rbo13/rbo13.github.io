  ...
  plays: [
    {
      ...
      badges: ['Go', 'MySQL', 'CI/CD', 'AWS', 'Deployment'],
      contents: `
Lead a small team of developers to work with our In-house, and Client Projects. We design and develop scalable backend architecture. Also, I am the point of contact in regards with our technical specifications. Configures our CI/CD pipeline for the deployment of our web applications using AWS running on ECS.
`
    },
    {
      ...
      badges: ['Go', 'MySQL', 'Docker', 'JavaScript', 'ReactJS'],
      contents: `
